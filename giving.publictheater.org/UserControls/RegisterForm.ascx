...
<fieldset>
	...
	<div class="Field" id="Field_Captcha">
		...
		<%--<recaptcha:RecaptchaControl ID="recaptcha" PublicKey="<%= Nysf.Web.UserControls.ConfigSection.Settings.RecaptchaPublicKey %>" PrivateKey="<%= Nysf.Web.UserControls.ConfigSection.Settings.RecaptchaPrivateKey %>" runat="server" />--%>
	</div>
</fieldset>
<div class="SubmitSet">
