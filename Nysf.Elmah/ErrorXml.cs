...
[assembly: Nysf.Elmah.Scc("$Id: ErrorXml.cs 754 2010-12-28 22:24:34Z azizatif $")]
...
namespace Nysf.Elmah
{
    ...
    public sealed class ErrorXml
    {
        ...
        private static void ReadInnerXml(XmlReader reader, Error error)
        {
            ...
            while (reader.IsStartElement())
            {
                ...
                switch (reader.Name)
                {
					...
					case "browserSession": collection = error.BrowserSession; break;
					case "tessSession": collection = error.TessSession; break;
					case "tessCart": collection = error.TessCart; break;
        ...
        private static void WriteInnerXml(Error error, XmlWriter writer)
        {
			...
			WriteCollection(writer, "browserSession", error.BrowserSession);
			WriteCollection(writer, "tessSession", error.TessSession);
			WriteCollection(writer, "tessCart", error.TessCart);
