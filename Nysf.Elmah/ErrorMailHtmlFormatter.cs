...
[assembly: Nysf.Elmah.Scc("$Id: ErrorMailHtmlFormatter.cs 566 2009-05-11 10:37:10Z azizatif $")]
...
namespace Nysf.Elmah
{
    ...
    public class ErrorMailHtmlFormatter : ErrorTextFormatter
    {
        ...
        protected virtual void RenderCollections()
        {
			...
			RenderCollection(this.Error.Form, "Form");
			RenderCollection(this.Error.QueryString, "Query String");
			RenderCollection(this.Error.Cookies, "Cookies");
			RenderCollection(this.Error.BrowserSession, "Browser Session");
			RenderCollection(this.Error.TessSession, "Tessitura Session");
			RenderCollection(this.Error.TessCart, "Tessitura Cart");
